...
from liar_liar.base_models.model_names import SIMPLENET_CIFAR100_NAME
...
class SimpleNetCIFAR100(CIFAR100Model):
    ...
    def __init__(self, optimizer=Adam(LEARNING_RATE), loss=tf.compat.v1.nn.softmax_cross_entropy_with_logits_v2, metrics=[categorical_accuracy, 'top_k_categorical_accuracy']):
