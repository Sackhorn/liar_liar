...
from liar_liar.models.image_net_models.image_net_dict import IMAGE_NET_DICT
...
def get_imagenet_models():
    ...
    Returns:
        list[ImageNetModel]:
    """
    from liar_liar.models.image_net_models.inception_v3_wrapper import InceptionV3Wrapper
    from liar_liar.models.image_net_models.mobilenetv2 import MobileNetV2Wrapper
    return [
        # ResNetWrapper(),
        InceptionV3Wrapper(),
        MobileNetV2Wrapper()
